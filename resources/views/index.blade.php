	...
	<h3>Devices</h3>
		...
		<h3>Weather</h3>
			<div class="container weather-container">
				<script type="text/javascript"> moWWidgetParams="moAllowUserLocation:false~moBackgroundColour:black~moColourScheme:grey~moDays:5~moDomain:www.metoffice.gov.uk~moFSSI:322089~moListStyle:vertical~moMapDisplay:bottom~moMapsRequired:CloudAndRain,Cloud,Rainfall,Pressure,Temperature~moShowFeelsLike:true~moShowUV:true~moShowWind:true~moSpeedUnits:M~moStartupLanguage:en~moTemperatureUnits:C~moTextColour:white~moGridParams:weather,temperature,wind,warnings,pop~"; </script><script type="text/javascript" src="https://www.metoffice.gov.uk/public/pws/components/yoursite/loader.js"> </script><p>This <a href='https://www.metoffice.gov.uk/public/weather/forecast/?tab=map?locId=322089' target='_blank' ><span id='moWWSiteName' >Canterbury</span> weather forecast</a> is generated by the <a href='https://www.metoffice.gov.uk/public/weather/components'>Met Office Weather Widget</a></p>
			</div>
</div>
